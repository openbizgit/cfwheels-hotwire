...
drawRoutes()
	...
	// other routes
	.get(name="signin", pattern="/signin", controller="public.Signin", action="index")
    .get(name="signout", pattern="/signout", controller="public.Signin", action="signout")
