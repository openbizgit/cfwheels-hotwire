<cfcomponent output="false" mixin="controller">
	...
	<cffunction name="JUnify" access="public" returntype="string" output="false">
        ...
        <testsuite errors="#loc.testresults.numErrors#" failures="#loc.testresults.numFailures#" name="#capitalize(arguments.params.type)# Tests" tests="#loc.testresults.numTests#" time="#DateDiff("n",loc.testresults.end,loc.testresults.begin)#" timestamp="#now()#">
            ...
            <testcase name="#loc.testresults.results[loc.i].testName#" time="#loc.testresults.results[loc.i].time#"><cfif loc.testresults.results[loc.i].status neq "Success"><failure message="#XmlFormat(HtmlCompressFormat(loc.testresults.results[loc.i].message))#">#XmlFormat(HtmlCompressFormat(loc.testresults.results[loc.i].message))#</failure></cfif></testcase>
            </cfloop>
