...
<div id="wheels-debug-area">
	<table cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td>Wheels #get("version")#<cfif loc.hasFrameworkTests> [<a href="#get('webPath')##ListLast(request.cgi.script_name, '/')#?controller=wheels&action=wheels&view=tests&type=core&reload=true">Run Tests</a>, <a href="#get('webPath')##ListLast(request.cgi.script_name, '/')#?controller=wheels&action=packages&view=tests&type=core&reload=true">View Tests</a>]</cfif></td>
		</tr>
		<tr>
